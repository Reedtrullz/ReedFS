...
- `2026-06-12-rfs-kpdx-landing-route-status-recompute.md` — current autonomous proof-tightening plan to ensure the KSEA-to-KPDX landing bridge recomputes near-destination route status after the KPDX 10L short-final seed, without claiming full-route/full-flight, VNAV, or route-coupled landing proof.
