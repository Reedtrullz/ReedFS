...
- `2026-06-12-rfs-effective-autoflight-control-ownership.md` — completed/current autonomous AP/FMA truth-tightening record ensuring active ticks, effective controls, manual-input sanitization, and saved-state restore use backed/effective autoflight truth, preventing unbacked raw AP truth from retaining or applying stale AP commands.
