...
const SOURCE_COMMIT = 'fe021a6f396a72f73cbaa160a710ef96f7fb21bf';
const SOURCE_COMMIT_DATE = '2026-06-17T01:53:12Z';
const AIRPORTS_URL = `https://raw.githubusercontent.com/davidmegginson/ourairports-data/${SOURCE_COMMIT}/airports.csv`;
const RUNWAYS_URL = `https://raw.githubusercontent.com/davidmegginson/ourairports-data/${SOURCE_COMMIT}/runways.csv`;
...
const metadata = {
  ...
  airportsSha256: sha256(airportsText),
  runwaysSha256: sha256(runwaysText),
